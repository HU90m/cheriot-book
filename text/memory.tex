...
When an object is freed, the allocator paints the bits associated with its location in memory.
...
\end{note}
\hugo{ I really like all the thoughtful clarifications like this one in this book. (Breaking up the little suggestions with some praise, do delete on reading.) }
