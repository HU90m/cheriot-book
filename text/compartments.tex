...
\hugo{
  A little more explanation here would be nice. Something like "The token API's methods normally require a cross compartment call, because ..." before introducing token_obj_unseal.
  Could potentially link to section "Allocating on behalf of the caller"?
}
